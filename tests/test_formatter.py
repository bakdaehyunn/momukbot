...
def test_format_groups_categories_and_adds_map_link() -> None:
    ...
    assert "   근거: https://blog.naver.com/a/b" in text
    assert "   지도: https://map.naver.com/p/search/%EC%84%9C%EB%A9%B4%20%EC%86%A1%EC%A0%953%EB%8C%80%EA%B5%AD%EB%B0%A5" in text
